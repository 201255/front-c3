...
function Index() {
    ...
    const urlupdate = 'http://18.207.215.184/api/product/update'
    ...
    const urldelet = 'http://18.207.215.184/api/product/delete'
    ...
    const url = 'http://18.207.215.184/api/product/create'
